...
public class OrderController {
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        orderService.addDeliveryPartnerInDB(partnerId);
        return new ResponseEntity<>("New delivery partner added successfully", HttpStatus.CREATED);
    }

    @PutMapping("/add-order-partner-pair")
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        orderService.addOrderPartnerPairInDB(orderId,partnerId);
    ...
    public ResponseEntity<Order> getOrderById(@PathVariable String orderId){
        ...
        Order order= orderService.getOrderByIdFromDB(orderId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = orderService.getPartnerByIdFromDB(partnerId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount = orderService.getOrderCountByPartnerIdFromDB(partnerId);
    ...
    public ResponseEntity<List<String>> getAllOrders(){
        List<String> orders = orderService.getOrdersFromDB();
